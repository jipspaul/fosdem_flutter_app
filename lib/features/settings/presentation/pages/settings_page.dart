...
import '../../utils/save_journey_io.dart' if (dart.library.html) '../../utils/save_journey_web.dart' as save_journey;
...
class _JourneyExportImportSectionState extends State<JourneyExportImportSection> {
  ...
  Future<void> _exportJourney(BuildContext context) async {
    ...
    try {
      ...
      final result = await save_journey.saveAndShareJourneyYaml(yaml);
      if (context.mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
